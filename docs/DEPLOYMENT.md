...
- Trên OpenAI Sites, đặt `SITES_OPERATOR_USER_IDS` thành danh sách phân tách bằng dấu phẩy của đúng các giá trị `oai-authenticated-user-id` được phép vận hành hệ thống.
